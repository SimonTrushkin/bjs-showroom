...
export const AnatomySimulator_BUILD_CFG:TPluginBuilderInput[] = [
    ...
    },
    {
        ...
        cfg: {
            ...
            buttons: [
                {id: 'Skeleton',  text:'Скелет', href:"/skeleton", desc:'Совокупность костей, хрящевой ткани и укрепляющих их связок. Старинный метод изготовления скелета — высушивание разделанной туши на солнце или в горячем песке.'},
                {id: 'Heart',   text:'Сердце', href:"/heart", desc:'Полый фиброзно-мышечный орган, обеспечивающий посредством повторных ритмичных сокращений ток крови по кровеносным сосудам.'},
                {id: 'Lungs',  text:'Легкие', href:"/lungs", desc:'В лёгких осуществляется газообмен между воздухом, находящимся в паренхиме лёгких, и кровью, протекающей по лёгочным капиллярам.'},
