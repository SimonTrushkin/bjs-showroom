...
export class V_UniversalCamera extends AbstractViewPlugin<typeof TV_UniversalCameraCfg>{
    ...
    private createCamera():void{
        this._camera = this._scene.getCameraById(this._cfg.getCamera) as UniversalCamera;
        if(!(this._camera && (this._camera.getClassName()=='UniversalCamera'||this._camera.getClassName()=='FreeCamera'))){
            this._camera = new UniversalCamera(this._cfg.name,this._cfg.position,this._scene);
